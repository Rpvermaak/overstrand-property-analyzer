...
* **Location encoding:** Adding suburb and city one-hot encoding was the single biggest R² jump (0.27 to 0.45)
...
*Built by [Ruben Vermaak](https://github.com/rpvermaak)*
